"""Python port of `packages/ai/test/google-thinking-signature.test.ts`."""
...
def test_does_not_treat_thought_signature_alone_as_thinking():
    # Per Google docs, thoughtSignature is for context replay and can appear on any part
    # type. Only thought === true indicates thinking content.
